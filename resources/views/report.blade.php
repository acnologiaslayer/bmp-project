...
<section style="margin: 5em 0em;">
		<div class="container">
			<form action="/reportMissing" method="post" class="columns is-multiline" enctype="multipart/form-data">
				{{ csrf_field() }}
				...
				<div class="field column is-4">
					...
					<div class="control">
						<input class="input" type="text" name="clothes">
					</div>
				</div>
				...
				<div class="field column is-12">
					...
					<div class="control">
						<textarea class="textarea" type="text" name="description" placeholder="Please descripbe what the missing person looks like..."></textarea>
					</div>
				</div>
